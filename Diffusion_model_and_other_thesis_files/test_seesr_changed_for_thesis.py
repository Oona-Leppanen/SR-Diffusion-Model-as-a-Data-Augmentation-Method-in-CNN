...
def load_tag_model(args, device='cuda'):
    ...
    model = ram(pretrained='drive/MyDrive/Yliopisto/Diplomityö/Code/SeeSR_Git_code/SeeSR_main/preset/models/ram_swin_large_14m.pth', # MUOKATTU
...
if __name__ == "__main__":
    ...
    parser.add_argument("--seesr_model_path", type=str, default='drive/MyDrive/Yliopisto/Diplomityö/Code/SeeSR_Git_code/SeeSR_main/preset/models/SeeSR_checkpoints/seesr')#None)
    parser.add_argument("--ram_ft_path", type=str, default='drive/MyDrive/Yliopisto/Diplomityö/Code/SeeSR_Git_code/SeeSR_main/preset/models/SeeSR_checkpoints/DAPE.pth')#None)
    parser.add_argument("--pretrained_model_path", type=str, default='drive/MyDrive/Yliopisto/Diplomityö/Code/SeeSR_Git_code/SeeSR_main/preset/models/stable-diffusion-2-base')#None)
    ...
    parser.add_argument("--image_path", type=str, default='drive/MyDrive/Yliopisto/Diplomityö/Datasets/example_images_for_thesis/seesr_with_ccsr_vae_test_input_imgs')#None)
    parser.add_argument("--output_dir", type=str, default='drive/MyDrive/Yliopisto/Diplomityö/Datasets/example_images_for_thesis/og_seesr_test_output_imgs')#None)
