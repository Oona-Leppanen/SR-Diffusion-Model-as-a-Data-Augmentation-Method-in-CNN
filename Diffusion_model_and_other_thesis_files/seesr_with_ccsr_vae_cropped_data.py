...
by Rongyuan Wu 
He has modified the original file from diffusers

Oona Leppänen
Created this copy 25.4.2025
Last modified 19.8.2025
'''
...
def load_seesr_pipeline(args, accelerator, enable_xformers_memory_efficient_attention):
	...
	vae = AutoencoderKL.from_pretrained(args.CCSR_VAE_model_path) #args.pretrained_model_path, subfolder="vae")
...
if __name__ == '__main__':
	...
	parser.add_argument("--image_path", type=str, default='drive/MyDrive/Yliopisto/Diplomityö/Datasets/metric_calculations/128_cropped_DIV2K_valid_dataset')
	parser.add_argument("--output_dir", type=str, default='drive/MyDrive/Yliopisto/Diplomityö/Datasets/metric_calculations/cropped_diffusion_DIV2K_valid_dataset')
	...
	parser.add_argument("--save_prompts", action='store_true') # Change to store_false if want to save tags.
