'''
Oona Leppänen has modified this file.
...
from transformers import AutoConfig, BertTokenizer # Changed: added AutoConfig
...
def init_tokenizer():
    config = AutoConfig.from_pretrained("drive/MyDrive/Yliopisto/Diplomityö/Code/SeeSR_Git_code/SeeSR_main/BertTokenizer/config.json") # MUOKATTU: lisätty
    tokenizer = BertTokenizer.from_pretrained('bert-base-uncased', config=config) # MUOKATTU: lisätty config=config
