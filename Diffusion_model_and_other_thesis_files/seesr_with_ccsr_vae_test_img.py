...
def main(args, enable_xformers_memory_efficient_attention = True,):
	...
	if accelerator.is_main_process:
		...
		txt_path = os.path.join(args.output_dir, 'test_output_txt')
...
if __name__ == '__main__':
	...
	parser.add_argument("--image_path", type=str, default='drive/MyDrive/Yliopisto/Diplomityö/Datasets/example_images_for_thesis/seesr_with_ccsr_vae_test_input_imgs')
	parser.add_argument("--output_dir", type=str, default='drive/MyDrive/Yliopisto/Diplomityö/Datasets/example_images_for_thesis/seesr_with_ccsr_vae_test_output_imgs')
